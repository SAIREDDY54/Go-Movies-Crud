...
func main() {
	...
	movies = append(movies, Movie{ID: "1", Title: "The Godfather", Isbn: "12345", Director: &Director{FirstName: "Francis", LastName: "Coppola"}})
	movies = append(movies, Movie{ID: "2", Title: "The Shawshank Redemption", Isbn: "78945", Director: &Director{FirstName: "Frank", LastName: "Darabont"}})
